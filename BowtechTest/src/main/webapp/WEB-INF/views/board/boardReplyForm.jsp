...
<div id="writeFormWrap">
	...
	<div>
		...
		<form name="writeForm" action="${conPath }/boardReply.do" method="post" enctype="multipart/form-data" onsubmit="return chkForm()">
		<input type="hidden" name="bNum" value="${boardDetail.bNum }">
		<input type="hidden" name="pageNum" value="${pageNum }">	
		<input type="hidden" name="bStep" value="${boardDetail.bStep }">
		<input type="hidden" name="bIndent" value="${boardDetail.bIndent }">
		<input type="hidden" name="bGroup" value="${boardDetail.bGroup }">
			<ul id="writeFormUl">
